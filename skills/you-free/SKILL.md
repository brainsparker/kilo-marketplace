...
name: you-free
description: >-
  Use the free You.com MCP profile for unauthenticated basic web search with
  `you-search` only.
compatibility: >-
  Requires network access and the You.com free MCP profile exposing
  `you-search`. Does not require `YDC_API_KEY` or OAuth.
license: MIT
metadata:
  mcp_servers: >-
